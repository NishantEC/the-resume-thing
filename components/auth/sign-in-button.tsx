...
export function SignInButton(): React.ReactElement {
  ...
  return (
    <button
      ...
      className="inline-flex h-[46px] items-center justify-center gap-2.5 rounded-[11px] border border-[#1c1c1c] bg-[#1c1c1c] px-[22px] text-[15px] font-semibold text-[#fafafa] shadow-[inset_0_1px_0_rgba(255,255,255,0.16),0_1px_3px_rgba(28,28,28,0.28)] hover:border-black hover:bg-black disabled:opacity-70"
    >
      <svg width="19" height="19" viewBox="0 0 24 24" fill="#fafafa">
